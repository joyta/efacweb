...
<div class="form-group">
    <label class="col-md-3 control-label">Fecha transferencia</label>
    <div class="col-md-4">
...
<!--De qué cuenta (mis cuentas)-->
<div class="form-group">
    <label class="col-md-3 control-label">De cuenta bancaria</label>
    <div class="col-md-8">
        <?= form_dropdown('pago[cuentabancaria_id]', $cuentas, '', 'id="pago_cuentabancaria_id" class="form-control required"')?>
    </div>
</div>

<!--A qué cuenta proveedor-->
<div class="form-group">
    <label class="col-md-3 control-label">A cuenta bancaria</label>
    <div class="col-md-8">
...
<div class="form-group">
    <label class="col-md-3 control-label">Del banco</label>
    <div class="col-md-8">        
