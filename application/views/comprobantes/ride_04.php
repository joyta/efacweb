...
<table style="width: 100%">
    <tr>
        ...
        <td rowspan="2" style="vertical-align: bottom; padding-left: 8px;">
            <div style="border: 1px solid #cacaca; border-radius: 6px; padding: 5px; line-height: 18px;">
                RUC.: <?=$empresa->documento?>
                <h2 class="heading">NOTA DE CRÉDITO</h2>
    ...
    <tr>        
        <td style="vertical-align: bottom;">
            <div style="border: 1px solid #cacaca; border-radius: 6px; padding: 5px;">
...
<table style="width: 100%; margin-top: 8px; border: 1px solid #cacaca;">
    <tr>
    ...
    <tr>
        ...
        <td>FACTURA</td>
        <td><?=$referencia->numero?></td>
    </tr>
    <tr>
        <td colspan="2">Fecha Emisión (Comprobante a modificar)</td>        
        <td colspan="2"><?=  date('d/m/Y', strtotime($referencia->fecha))?></td>
    </tr>
    <tr>
        <td colspan="2">Razón modificación</td>        
        <td colspan="2"><?=$comprobante->descripcion?></td>
    </tr>
</table>
