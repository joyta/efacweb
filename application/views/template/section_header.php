...
<header id="header">
        ...
        <div class="project-context hidden-xs">
                ...
                <span id="project-selector" class="popover-trigger-element dropdown-toggle" data-toggle="dropdown">Actividades recientes <i class="fa fa-angle-down"></i></span>
        ...
        <div class="pull-right">
                ...
                <form action="<?= base_url() ?>search.php" class="header-search pull-right">
                        <input type="text" name="param" placeholder="Buscar reportes y mas" id="search-fld">
                        <button type="submit">
                ...
                <ul class="header-dropdown-list hidden-xs">
                        <li>
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
                                        <img src="<?= base_url() ?>img/blank.gif" class="flag flag-es" alt="Español ecuador"> <span> Español (EC) </span> <i class="fa fa-angle-down"></i> </a>
                                <ul class="dropdown-menu pull-right">
                                        <li class="active">
