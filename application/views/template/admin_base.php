...
<html lang="en-us" >
	<head>
		...
		<title> DataTables - SmartAdmin </title>
		...
		<script src="<?= base_url() ?>js/libs/jquery/jquery-2.1.1.min.js"></script>
		<script>
			if (!window.jQuery) {
		...
		<script src="<?= base_url() ?>js/libs/jqueryui/jquery-ui-1.10.3.min.js"></script>
		<script>
			if (!window.jQuery.ui) {
...
<div id="main" role="main">
	...
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li><a href="http://www.xodyn.com/smartAdmin/1.5.2/ver/PHP_version/PHP_HTML_Version">Home</a></li><li>Tables</li><li>DataTables</li>		</ol>
		<!-- end breadcrumb -->
