...
<section id="widget-grid" class="">
    ...
    <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-rep-stock-max" data-widget-editbutton="true" data-widget-refreshbutton="true">
                <!-- widget options:
                ...
                <header>
                    ...
                    <h2>Lista de productos sobre la cantidad máxima </h2>
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-inline" action="<?=  base_url()?>reportes/stock_maximo" method="post">                            
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>                                    
                                    ...
                                    <td class="text-right"><?=  number_format($item->cantidad - $item->cantidad_maxima,2)?></td>                                    
                                </tr>
                                <? endforeach;?>
                            </tbody>                            
                        </table>
