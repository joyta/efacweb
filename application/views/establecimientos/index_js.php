...
<script type="text/javascript">
    ...
    function EliminarEstablecimiento(id, nombre, elm) {
        efac.deleteBox('Eliminar', '¿Desea eliminar el establecimiento?', function() {
            $.ajax({
                url: '<?= base_url() ?>establecimientos/delete/' + id,
                type: 'get',
                dataType: 'json',
