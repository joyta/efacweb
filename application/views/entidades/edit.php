                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input name="documento" id="documento" class="form-control required" placeholder="Número del documento" type="text" maxlength="15" value="<?= $model->documento ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-10">
                                                <div class="checkbox">
                                                    <label>
                                                        <input name="is_proveedor" id="is_proveedor" placeholder="Es proveedor" type="checkbox" value="1" <?= $model->is_proveedor=='t' ?"checked=''":""?> /> Es proveedor 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
