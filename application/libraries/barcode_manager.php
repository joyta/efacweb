...
class CI_Barcode_manager {
    ...
    public function create_barcode($code, $center_x, $center_y, $width, $height, $bars_width, $bars_height)
    {
        ...
        $x = $center_x; // barcode center
        $y = $center_y; // barcode center
        //$height = $bars_height; // barcode height in 1D ; module size in 2D
        //$width = $bars_width; // barcode height in 1D ; not use in 2D
        ...
        // BARCODE
        // -------------------------------------------------- //
        $data = Barcode::gd($im, $black, $x, $y, $angle, $type, array('code'=>$code), $bars_width, $bars_height);
